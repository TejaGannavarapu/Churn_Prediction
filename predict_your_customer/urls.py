...
urlpatterns = [
    ...
    path("UserTestRecordResult/", usr.UserTestRecordResult, name="UserTestRecordResult"),
    path("UserSVM/", usr.UserSVM, name="UserSVM"),
    path("UserChurn/",usr.UserChurn, name = "UserChurn")
    #path("SVMResult/",usr.SVMResult,name = 'SVMResult')
]
